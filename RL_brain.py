...
class DeepQNetwork:
    ...
    def __init__(
            ...
            reward_decay=0.9,
            e_greedy=0.9,
            replace_target_iter=300,#隔了300步把target-net换成最新的
            memory_size=500,#记忆库容量
        ...
        # 记录学习次数 (用于判断是否更换 target_net 参数)记录学习多少步
    ...
    def _build_net(self):
        ...
        self.q_target = tf.placeholder(tf.float32, [None, self.n_actions], name='Q_target')  # 用来接收 q_target 的值即Q现实, 这个之后会通过计算得到
    ...
    def choose_action(self, observation):
        ...
        observation = observation[np.newaxis, :]#变成2维数据
